...
MODULE seq_infodata_mod
  ...
  type seq_infodata_type
     ...
     logical                 :: rofocn_prognostic ! Dongyu does component need ocn data
...
CONTAINS
  ...
  SUBROUTINE seq_infodata_Init( infodata, nmlfile, ID, pioid, cpl_tag)
    ...
    if (seq_comm_iamroot(ID)) then
       ...
       infodata%rofocn_prognostic = .false.  ! Dongyu
  ...
  SUBROUTINE seq_infodata_GetData_explicit( infodata, cime_model, case_name, case_desc, timing_dir,  &
    ...
    logical,                optional, intent(OUT) :: rofocn_prognostic       ! Dongyu
    ...
    if ( present(rofocn_prognostic) ) rofocn_prognostic = infodata%rofocn_prognostic  ! Dongyu
  ...
  SUBROUTINE seq_infodata_PutData_explicit( infodata, cime_model, case_name, case_desc, timing_dir,  &
    ...
    logical,                optional, intent(IN)    :: rofocn_prognostic  ! Dongyu
    ...
    if ( present(rofocn_prognostic) ) infodata%rofocn_prognostic = rofocn_prognostic  ! Dongyu
  ...
  subroutine seq_infodata_bcast(infodata,mpicom)
    ...
    call shr_mpi_bcast(infodata%rofocn_prognostic,       mpicom)  ! Dongyu
  ...
  subroutine seq_infodata_Exchange(infodata,ID,type)
    ...
    if (rof2cpli) then
       ...
       call shr_mpi_bcast(infodata%rofocn_prognostic,  mpicom, pebcast=cmppe)  ! Dongyu
    ...
    if (cpl2i) then
       ...
       call shr_mpi_bcast(infodata%rofocn_prognostic,  mpicom, pebcast=cplpe) ! Dongyu
  ...
  SUBROUTINE seq_infodata_print( infodata )
    ...
    write(logunit,F0L) subname,'rofocn_prognostic        = ', infodata%rofocn_prognostic ! Dongyu
